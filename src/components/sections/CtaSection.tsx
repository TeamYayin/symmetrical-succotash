    ...
    <section className="py-32 bg-text-primary text-bg-primary">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
          ...
          <a href="https://www.linkedin.com/company/yayinailab/" target="_blank" rel="noopener noreferrer" className="font-mono text-sm uppercase tracking-wider text-bg-primary/80 hover:text-accent transition-colors">
            Connect on LinkedIn
          </a>
        </div>
      </div>
